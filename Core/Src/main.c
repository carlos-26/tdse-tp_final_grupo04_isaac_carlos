...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	if (HAL_GetTick() - LastTick >= 1) // Ejecuta cada 1 milisegundo
	{
...
/* USER CODE BEGIN MX_GPIO_Init_1 */
  //__HAL_AFIO_REMAP_SWJ_NOJTAG(); // Deshabilita JTAG pero deja activo SWD (para que poder seguir programando)
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_2|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_8
  ...
  /*Configure GPIO pins : PC2 PC5 PC6 PC8
                           PC9 PC10 PC11 */
